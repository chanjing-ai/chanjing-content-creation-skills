...
- **本文件（`chanjing-ai-creation_SKILL.md`）**：业务逻辑、追问与异常语义；据此调度 [`scripts/cli_capabilities.py`](scripts/cli_capabilities.py) 与 [`scripts/`](scripts/) 下脚本。
...
python3 skills/chanjing-content-creation-skill/products/chanjing-ai-creation/scripts/poll_task --unique-id "$TASK_ID"
```
